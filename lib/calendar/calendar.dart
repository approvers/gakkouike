  ...
  Future setAbsence() async {
    ...
    for (Subject subject in subjects) {
      for (DateTime dateTime in subject.absenceDates) {
        if (map[dateTime] is List<Subject>)
          map[dateTime].add(subject);
        else
          map[dateTime] = <Subject>[subject];
      }
    }
        ...
        child: Column(
          ...
          TableCalendar(
            ...
            builders: CalendarBuilders(markersBuilder:
                (BuildContext context, DateTime date, events, holidays) {
            ...
            child: Container(
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      Text(
                          (selectedDay != null
                              ? "${selectedDay.year}年${selectedDay.month}月${selectedDay.day}日の欠課"
                              : "日付選んでクレメンス"),
